    ...
    >
      ...
      >
        <motion.a
          ...
          className="card group card-violet"
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/60">bakibillahrahat@protonmail.com</p>
            </div>
          </div>
        </motion.a>

        <motion.a
          href="https://linkedin.com/in/bakibillahrahat"
          target="_blank"
          rel="noopener noreferrer"
          className="card group card-cyan"
          variants={itemVariants}
          whileHover={{ scale: 1.05 }}
        >
          <div className="flex items-center gap-4">
        ...
        <motion.a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="card group card-green"
          variants={itemVariants}
          whileHover={{ scale: 1.05 }}
        >
          <div className="flex items-center gap-4">
      ...
      >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg bg-white/10 border border-white/20 
                         hover:border-white/40 focus:border-violet-500 focus:outline-none
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-2 rounded-lg bg-white/10 border border-white/20 
                       hover:border-white/40 focus:border-violet-500 focus:outline-none
                       text-white placeholder-white/40 transition-colors resize-none"
        ...
        <button
          ...
          className="gradient-btn w-full justify-center disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {status === "loading" ? (
            <>
